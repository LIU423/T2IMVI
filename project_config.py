...
RELIABILITY_ANALYSIS_COMPARISON_DIR = DATA_DIR / "reliability_analysis" / "comparison"
...
def get_all_paths() -> Dict[str, str]:
    ...
    return {
        ...
        "RELIABILITY_ANALYSIS_COMPARISON_DIR": str(RELIABILITY_ANALYSIS_COMPARISON_DIR),
