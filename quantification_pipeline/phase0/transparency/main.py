"""
Main entry point for transparency evaluation.
...
Usage:
    ...
    # Full run
    python -m quantification_pipeline.phase0.transparency.main
    
    # Resume from checkpoint (default behavior)
    python -m quantification_pipeline.phase0.transparency.main
    
    # Start fresh (ignore checkpoint)
    python -m quantification_pipeline.phase0.transparency.main --no-resume
    
    # Use different model
    python -m quantification_pipeline.phase0.transparency.main --model qwen3-0.6b
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate semantic transparency of idioms using LLMs.",
