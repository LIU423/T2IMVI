"""
Qwen3-0.6B model implementation for transparency evaluation.

This module implements the BaseTransparencyModel interface for the
...
class Qwen3Model(BaseTransparencyModel):
    """
    Qwen3-0.6B implementation for transparency evaluation.
    ...
    def format_prompt(self, idiom: str, definition: str, system_prompt: str) -> str:
        ...
        The prompt asks the model to classify transparency and expects
        a yes/no response.
        """
