...
class TransparencyResult:
    """Result of transparency evaluation for a single idiom."""
    idiom_id: int
    idiom: str
    definition: str
    transparency: float  # P(yes) - the probability of "yes"
...
class DataHandler:
    ...
    def __init__(
        ...
        self._prompt: str = ""
        self._results: Dict[int, TransparencyResult] = {}  # idiom_id -> result
    ...
    def add_result(self, result: TransparencyResult) -> None:
