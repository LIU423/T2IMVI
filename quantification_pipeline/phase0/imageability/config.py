"""
Configuration management for imageability evaluation pipeline.
...
PROMPT_FILE = PHASE0_IMAGEABILITY_PROMPT

# Output paths
OUTPUT_DIR = OUTPUT_PHASE0_DIR
OUTPUT_FILE = OUTPUT_DIR / "imageability_results.json"
CHECKPOINT_FILE = OUTPUT_DIR / "imageability_checkpoint.json"
...
def get_model_class(model_name: str) -> Type:
    ...
    To add a new model:
    1. Create a new file implementing BaseImageabilityModel
...
@dataclass
class EvalConfig:
    """Configuration for imageability evaluation."""
